  ...
  return (
    <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
      ...
      <div className="relative">
            ...
            {place.photos?.[0] && (
              <div>
                <img
                  ...
                  src={'http://localhost:1000/uploads/' + place.photos[0]}
                  alt=""
                />
              </div>
            )}
          ...
          <div className="grid">
            {place.photos?.[1] && (
              <img
                onClick={() => setShowAllPhotos(true)}
                className="aspect-square object-cover cursor-pointer"
                src={'http://localhost:1000/uploads/' + place.photos[1]}
                alt=""
              />
            )}
            {place.photos?.[2] && (
              <div className="overflow-hidden">
                <img
                  ...
                  src={'http://localhost:1000/uploads/' + place.photos[2]}
                  alt=""
                />
              </div>
            )}
        ...
        <button
          onClick={() => setShowAllPhotos(true)}
          className="flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl border boder-black shadow shadow-gray-500"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
